const Introduction = (): JSX.Element => {
  return (
    <div className="relative">
      ...
      <div className="absolute left-49% bottom-18% 2xl:bottom-7% w-3/4 z-0 hidden lg:flex" data-aos="fade-left">
        <div
      ...
      <div className="absolute left-48% bottom-16% 2xl:bottom-5% w-3/4 z-0 hidden lg:flex" data-aos="fade-left">
        <div
          className="w-1/2 h-25vw border-5 relative "
          style={{
