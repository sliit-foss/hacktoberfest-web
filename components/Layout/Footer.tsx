      ...
      <div className="w-full lg:flex lg:flex-col z-40">
        <div className="w-full lg:flex lg:flex-row justify-between bg-green-lighter lg:h-60 px-10%">
          <div className="w-full lg:w-1/2 flex flex-col justify-start items-center lg:items-start">
            <div className="w-full md:mb-4 lg:mb-3 mt-2 px-10 text-center lg:text-left">
              ...
              <form className="flex flex-row justify-center lg:justify-start items-center mt-2 mb-4 sm:mb-3 relative">
                ...
                />
                <button type="submit" className="absolute right-auto lg:right-1/4 bottom-0 mr-0 lg:mr-2 mb-2 px-5 w-97% lg:w-auto bg-red-light hover:bg-red-dark shadow-lg hover:shadow-xl py-2 w-1/4 flex justify-center items-center text-white font-sans font-semibold rounded-md lg:rounded-full cursor-pointer transition ease-in duration-200">
                  Get Updates
                </button>
              </form>
            </div>
